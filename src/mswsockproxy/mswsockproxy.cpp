...
const BYTE kActiveRangeCharacterOutdoorExpected[kActiveRangePatchLength] = {
    0xE8, 0x90, 0x06, 0x10, 0x00, 0xD9, 0x80, 0xE0, 0x00, 0x00, 0x00};
const BYTE kActiveRangeCharacterIndoorExpected[kActiveRangePatchLength] = {
    0xE8, 0x83, 0x06, 0x10, 0x00, 0xD9, 0x80, 0xDC, 0x00, 0x00, 0x00};
const BYTE kActiveRangeItemOutdoorExpected[kActiveRangePatchLength] = {
    0xE8, 0x46, 0xA3, 0x09, 0x00, 0xD9, 0x80, 0xE0, 0x00, 0x00, 0x00};
const BYTE kActiveRangeItemIndoorExpected[kActiveRangePatchLength] = {
    0xE8, 0x39, 0xA3, 0x09, 0x00, 0xD9, 0x80, 0xDC, 0x00, 0x00, 0x00};
...
const ActiveRangePatchSite kActiveRangePatchSites[] = {
    {"CCharacter outdoor active range consumer", 0x00541CFB, kActiveRangeCharacterOutdoorExpected, &kActiveRangeFixedOutdoor, "36"},
    {"CCharacter indoor active range consumer", 0x00541D08, kActiveRangeCharacterIndoorExpected, &kActiveRangeFixedIndoor, "24"},
    {"CItem outdoor active range consumer", 0x005A8045, kActiveRangeItemOutdoorExpected, &kActiveRangeFixedOutdoor, "36"},
    {"CItem indoor active range consumer", 0x005A8052, kActiveRangeItemIndoorExpected, &kActiveRangeFixedIndoor, "24"},
};
